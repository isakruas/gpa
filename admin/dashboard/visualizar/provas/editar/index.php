        ...
        <div class="main-l">
            ...
            <div class="main-m">
                <script type="text/javascript">
                  document.getElementById('info').innerHTML = '<h2>VISUALIZAR - PROVA(S) - EDITAR</h2>';
                </script>
                ...
                <div class="main-one-columns">
                  <div class="main-one-columns-one">
                        ...
                        <br>
                          ...
                          <button class="a b" onclick="atualizar_prova()" type="submit">Salvar alteração</button>
...
var query = location.search.slice(1);
  ...
  partes.forEach(function (parte) {
    ...
    System.Ajax.Get({
      url:"../../../../api.php", 
      data:"x=buscar_prova_id&id="+data.id,
      success:function(json){

        var rtn = JSON.parse(json);
        console.log(rtn.nome);

        document.getElementById('prova_nome').value = rtn[0]['nome'];
        document.getElementById('prova_status').value = rtn[0]['status'];
 
      } 
    });


function atualizar_prova() {
    ...
    if (prova_status >= 0 && prova_status < 3) {
      ...
      if (prova_nome !== "") {
        ...
        System.Ajax.Get({
             url:"../../../../api.php", 
            data: "x=atualizar_prova_id&id="+data.id+"&nome="+prova_nome+"&status="+prova_status,
