        ...
        <div class="main-l">
            ...
            <div class="main-m">
                <script type="text/javascript">
                  document.getElementById('info').innerHTML = '<h2>VISUALIZAR - CURSO(S) - EDITAR</h2>';
                </script>
                ...
                <div class="main-one-columns">
                  <div class="main-one-columns-one">
                        ...
                        <br>
                          ...
                          <button class="a b" onclick="atualizar_curso()" type="submit">Salvar alteração</button>
...
var query = location.search.slice(1);
  ...
  partes.forEach(function (parte) {
    ...
    System.Ajax.Get({
      url:"../../../../api.php", 
      data:"x=buscar_curso_id&id="+data.id,
      success:function(json){

        var rtn = JSON.parse(json);
        console.log(rtn.nome);

        document.getElementById('curso_nome').value = rtn[0]['nome'];
...
function atualizar_curso() {
    ...
    System.Ajax.Get({
      url:"../../../../api.php", 
      data:"x=atualizar_curso_id&id="+data.id+"&nome="+document.getElementById('curso_nome').value,
